...
There is also a dynamically generated glossary page populated by `/src/components/glossary.astro`  [on github](https://github.com/userdocs/starlight-glossary/blob/main/src/components/glossary.astro)
